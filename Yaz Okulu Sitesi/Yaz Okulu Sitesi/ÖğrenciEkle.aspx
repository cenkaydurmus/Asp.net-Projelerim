<%@ Page Title="" Language="C#" MasterPageFile="~/AnaSayfa.master" AutoEventWireup="true" CodeFile="ÖğrenciEkle.aspx.cs" Inherits="ÖğrenciEkle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <form id="form1" runat="server">
        ...
        <tr>
            ...
            <td class="text-left">
                <asp:Button  Font-Size="Large" ID="btnkayıtol" runat="server" Height="74px" Text="Kayıt Ol" Width="168px" OnClick="btnkayıtol_Click" />
            </td>
        </tr>
    </table>
    </form>
