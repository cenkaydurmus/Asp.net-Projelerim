<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ÖğrenciEkle.aspx.cs" Inherits="Yaz_Okulu.ÖğrenciEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btn" runat="server" Text="Button" CssClass="btn btn-danger" OnClick="btn_Click" />
    </form>
