<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Makineler2.aspx.cs" Inherits="Huzur_Vinç.Makineler2" %>
...
<body>
  ...
  <div class="news-container" style="margin-bottom: 45px;">
        <p class="services-header">MAKİNELER VE EKİPMANLAR</p>

        <asp:DataList ID="DataList1" runat="server" Width="100%">
            <ItemTemplate>
                <div class="news-container" style="margin-bottom: 45px;min-height:1000px">
                    <a href="#" class="links" style="color: black;">
                        <p class="news-header"><%# Eval("VehicleName") %></p>
                    </a>
                    <img class="news-img" src='<%# Eval("VehiclePhoto") %>'>
