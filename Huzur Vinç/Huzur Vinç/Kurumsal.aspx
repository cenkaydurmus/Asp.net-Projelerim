<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kurumsal.aspx.cs" Inherits="Huzur_Vinç.Kurumsal" %>
...
<body runat="server" id="PageBody" >
    <nav class="navbar">
      ...
      <div style="margin-top: 50px;margin-bottom: 50px;width:500px;margin-left:25px">
