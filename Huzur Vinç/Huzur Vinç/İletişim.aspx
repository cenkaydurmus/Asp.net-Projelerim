<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="İletişim.aspx.cs" Inherits="Huzur_Vinç.İletişim" %>
...
<body runat="server" id="PageBody">
  <nav class="navbar">
        ...
        <div style="font-size: 25px; margin-left: -80px; color: whitesmoke;">HUZUR </div>
      ...
      <div class="contact-div">
        ...
        <p class="services-header" style="margin-top: 25px;color:#439343;">HALİL KALKAN</p>
        ...
        <span>Telefon numarası :</span>
         ...
         <div class="contact-info">
            <span>Ofis adresi :</span>
              <span>&nbsp;</span>
              <span>&nbsp;</span>
             <asp:Label ID="LabelAdress" runat="server" ></asp:Label>
             ...
             <a class="links" style="color: black;" id="linkgmaps" runat="server" target="_blank" >
                <div class="contact-info">
                    <i  style="line-height: 30px;" class="fas fa-map-marked-alt"></i>
                    <span style="margin-left: 5px;">Adresi haritada görüntülemek için tıklayınız</span>
                     </div>
             </a>
            ...
            <p class="services-header" style="margin-top: 75px;color:#439343;margin-left: 25px;">Bİze mesaj gönderin</p>

    <div class="contact-form" style="margin-bottom:25px">
        ​<form  runat="server">
            <label for="fname">Ad</label>
            <input runat="server" type="text" id="fname" name="firstname" placeholder="Adınızı giriniz..">
        
            <label for="lname">Soyad</label>
            <input runat="server" type="text" id="lname" name="lastname" placeholder="Soyadınızı giriniz..">
        
            <label for="lmail">Mail</label>
            <input runat="server" type="text" id="lmail" name="mail" placeholder="Mail adresinizi giriniz..">
           
            <label for="subject">Mesaj</label>
            <textarea runat="server" id="subject" name="subject" placeholder="Mesajınızı yazınız.." style="height:200px"></textarea>

            <asp:Button ID="btnSendMsg" runat="server" Text="Gönder" CssClass="btn-send" OnClick="btnSendMsg_Click" />
