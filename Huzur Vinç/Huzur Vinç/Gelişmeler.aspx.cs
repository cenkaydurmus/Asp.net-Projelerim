...
{
    public partial class Gelişmeler : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            SqlCommand commandNews = new SqlCommand("Select * from TableNews ORDER BY NewsID DESC", SqlConnectionClass.con);
